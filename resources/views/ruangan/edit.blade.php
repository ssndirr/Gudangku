<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Ruangan</h2>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('ruangan.update', $ruangan) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama_ruangan" name="nama_ruangan" value="{{ old('nama_ruangan', $ruangan->nama_ruangan) }}" required autofocus
